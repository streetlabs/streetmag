class ArticlesController < ApplicationController
  ...
  def create
    ...
    if @article.save
      redirect_to(publication_articles_path(@publication), :notice => 'Article was successfully created.')
    else
        render :action => "new"
    end
  ...
  def update
    ...
    if @article.update_attributes(params[:article])
      redirect_to( publication_article_path(@publication, @article), :notice => 'Article was successfully updated.')
    else
      render :action => "edit" 
    end
