...
describe PublicationsController do
  ...
  def mock_publication(stubs={})
    (@mock_publication ||= mock_model(Publication).as_null_object).tap do |publication|
      publication.stub(stubs) unless stubs.empty?
    end
  end

  describe "GET index" do
    it "assigns all publications as @publications" do
      Publication.stub(:all) { [mock_publication] }
      get :index
      assigns(:publications).should eq([mock_publication])
    end
  end

  describe "GET show" do
    it "assigns the requested publication as @publication" do
      Publication.stub(:find).with("37") { mock_publication }
      get :show, :id => "37"
      assigns(:publication).should be(mock_publication)
    end
  end

  describe "GET new" do
    it "assigns a new publication as @publication" do
      Publication.stub(:new) { mock_publication }
      get :new
      assigns(:publication).should be(mock_publication)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created publication as @publication" do
        Publication.stub(:new).with({'these' => 'params'}) { mock_publication(:save => true) }
        post :create, :publication => {'these' => 'params'}
        assigns(:publication).should be(mock_publication)
      end

      it "redirects to the created publication" do
        Publication.stub(:new) { mock_publication(:save => true) }
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved publication as @publication" do
        Publication.stub(:new).with({'these' => 'params'}) { mock_publication(:save => false) }
        post :create, :publication => {'these' => 'params'}
        assigns(:publication).should be(mock_publication)
      end

      it "re-renders the 'new' template" do
        Publication.stub(:new) { mock_publication(:save => false) }
        post :create, :publication => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested publication" do
        Publication.should_receive(:find).with("37") { mock_publication }
        mock_publication.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :publication => {'these' => 'params'}
      end

      it "assigns the requested publication as @publication" do
        Publication.stub(:find) { mock_publication(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:publication).should be(mock_publication)
      end
    ...
    describe "with invalid params" do
      it "assigns the publication as @publication" do
        Publication.stub(:find) { mock_publication(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:publication).should be(mock_publication)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the publications list" do
      Publication.stub(:find) { mock_publication }
      delete :destroy, :id => "1"
